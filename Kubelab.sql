...
--
-- Vært: mysql
-- Genereringstid: 10. 12 2024 kl. 14:16:49
-- Serverversion: 8.4.3
-- PHP-version: 8.2.26
...
--
ALTER TABLE `Services`
  MODIFY `ServiceId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `Templates`
  MODIFY `TemplateId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
